...
カテゴリが3の場合は、その状態を構成している感情を最大5つcomponentEmotionsに列挙してください。
感情は日本語の一般的な感情表現で返してください（例: 温かさ、安らぎ、幸福感、懐かしさ）。`;
          ...
          responseSchema: {
            ...
            properties: {
              ...
              componentEmotions: {
                ...
                description: "カテゴリ3の場合の構成感情リスト（最大5つ）",
              },
            },
      ...
      return result as { category: number; reason: string; componentEmotions?: string[] };
    } catch (error) {
